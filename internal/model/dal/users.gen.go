...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Userid = field.NewInt64(tableName, "userid")
	_user.Username = field.NewString(tableName, "username")
	_user.Avatar = field.NewString(tableName, "avatar")
	_user.Openid = field.NewString(tableName, "openid")
	_user.Sessionkey = field.NewString(tableName, "sessionkey")
	_user.Userpoint = field.NewInt32(tableName, "userpoint")
	_user.Userstatus = field.NewBool(tableName, "userstatus")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Sessionkey = field.NewString(table, "sessionkey")
	u.Userpoint = field.NewInt32(table, "userpoint")
	u.Userstatus = field.NewBool(table, "userstatus")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["sessionkey"] = u.Sessionkey
	u.fieldMap["userpoint"] = u.Userpoint
	u.fieldMap["userstatus"] = u.Userstatus
