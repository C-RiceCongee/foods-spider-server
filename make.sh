...
# window 打包镜像
docker build -f .\deployment\dockerfile.yaml . -t changhao970520/spider
printf "执行打包go"
# 执行打包go
...
docker run --name spider -v C:\Users\19333\GolandProjects\foods-spider-server\conf:app/conf  -p 9999:8888 spider